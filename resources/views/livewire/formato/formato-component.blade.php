                ...
                <tbody class="bg-white">
                    @foreach ($tabla as $key) 
                        <tr>
                            ...
                            <td>{{ $key->Nombre}}</td>
                         <td><button class="btn btn-warning btn-sm" wire:click="accion(2,{{$key->id}})"><span class="fas fa-edit"></span></button><a href="{{url('formatos/datos_formatos')}}\{{$key->id}}" class="btn btn-primary btn-sm"><span class="fa fa-search"></span></a><button onclick="eliminar({{ $key->id}})" class="btn btn-danger btn-sm"><span class="fa fa-times"></span></button></td>  
                         </tr> 
                    @endforeach
                </tbody>
            </table>
