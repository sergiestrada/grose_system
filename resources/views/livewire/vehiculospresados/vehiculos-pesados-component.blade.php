...
<article class="container-fluid">
   ...
   <br>
                ...
                <tbody class="bg-white">
                    @foreach ($tabla as $key) 
                        <tr>
                            ...
                            <td>{{$key->Poliza}}</td>
                            <td>{{$key->Tipo}}</td> 
                         <td><button class="btn btn-warning btn-sm" wire:click="accion(2,{{$key->id}})"><span class="fas fa-edit"></span></button><button wire:click="accion(0,{{$key->id}})" class="btn btn-primary btn-sm"><span class="fa fa-search"></span></button><button wire:click="accion(3,{{$key->id}})" class="btn btn-sm btn-secondary"><span class="fa fa-upload"></span></button><button onclick="eliminar({{$key->id}})" class="btn btn-danger btn-sm"><span class="fa fa-times"></span></button></td>  
                         </tr> 
                    @endforeach
                </tbody>
            </table>
    ...
    @include('livewire.vehiculospresados.form')
</article>
@section('js')
    <script>
