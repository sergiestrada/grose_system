...
<article class="container-fluid">
    ...
    <div class="row">
        ...
        <section class="col-md-12" id="myContent">
            @php 
                $datos = App\Models\Vehiculos::where('numint',$numint)->first();
            @endphp
            <img  src="{{url('img/logo.jpeg')}}" style="width:20%;height:50px" id="salesImage" >
                 <h2>{{ $pageTitle }}</h2><br>
             
         <h2> <b> [{{$datos->Placa}}]   @if($datos->Comentarios != ''){{$datos->Comentarios}}@endif</b></h2>
...
<script>
      document.addEventListener('DOMContentLoaded', function() {
        $('#exportExcel').on('click', function() {
                ...
                var worksheet = workbook.addWorksheet("Reporte_vehiculos_pesados");
        ...
        html2canvas(content).then(canvas => {
            ...
            // Descargar el PDF
            pdf.save('Reporte_vehiculos_pesados.pdf');
        });
    });
    })
</script>
